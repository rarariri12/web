...
form.addEventListener('submit', function (e) {
    ...
    fetch(url).then((response) => {
        ...
        if (weatherMain == 'Clear') {
            image.src = `https://cdn-icons-png.flaticon.com/128/7865/7865939.png`
            myWeatherContainer.style.backgroundColor = '#ec6e4c'
        }
        if (weatherMain == 'Clouds') {
            image.src = `https://cdn-icons-png.flaticon.com/128/5904/5904053.png`
            myWeatherContainer.style.backgroundColor = '#2d7ce2'
        }
        if (weatherMain == 'Rain') {
            image.src = `https://cdn-icons-png.flaticon.com/128/4246/4246656.png`
            myWeatherContainer.style.backgroundColor = '#bdb3b3'
        }
        if (weatherMain == 'Drizzle') {
            image.src = `https://cdn-icons-png.flaticon.com/128/2524/2524402.png`
            myWeatherContainer.style.backgroundColor = '#8ecfcf'
        }
        if (weatherMain == 'Haze') {
            image.src = `https://cdn-icons-png.flaticon.com/128/9369/9369771.png`
